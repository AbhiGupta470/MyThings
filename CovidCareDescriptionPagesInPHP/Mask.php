            ...
            <div class = "product-div">
                <div class = "product-div-left">
                    <div class = "img-container">
                        <img src = "Covid Care\Mask\Screenshot 2022-11-21 105311.png" alt = "watch">
                    </div>
                    <div class = "hover-container">
                        <div><img src = "Covid Care\Mask\Screenshot 2022-11-21 105311.png"></div>
                        <div><img src = "Covid Care\Mask\dcf0008_1.jpg"></div>
                        <div><img src = "Covid Care\Mask\dcf0008_2.jpg"></div>
                        <div><img src = "Covid Care\Mask\dcf0008.jpg"></div>
                        <div><img src = "Covid Care\Mask\dcg0005.jpg"></div>
                    </div>
                </div>
                <div class = "product-div-right">
                    <span class = "product-name"> Face-Mask</span>
                    ...
                    <p class = "product-description">Comfortable elastic ear loop. It has an extra soft ear loop, a unique design that is made of 3 layers of non-woven fiber fabric to provide fine filtration and maximum breathability. Safe and effective masks that are 100% latex-free. Lightweight and skin-friendly texture and are free from flaws.</p>
                    <br>
                    <p class = "product-description">
                        <ul class="product-description">
                        <h4>Contraindications of Face-Mask</h4>
                        
                        <li> In patients with facial injuries. </li>
                        <li>For patients who will not leave the mask in place.</li>  
                        <!-- <li>If you have perforations in your eardrum (a thin membrane that separates your ear canal from your middle ear).</li> -->
                       <!-- <li>If you have asthma or experienced an asthmatic attack due to painkillers.</li>   -->
