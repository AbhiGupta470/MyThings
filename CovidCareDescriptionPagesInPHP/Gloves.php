            ...
            <div class = "product-div">
                <div class = "product-div-left">
                    <div class = "img-container">
                        <img src = "Covid Care\Gloves\2_12_4.webp" alt = "watch">
                    </div>
                    <div class = "hover-container">
                        <div><img src = "Covid Care\Gloves\2_12_4.webp"></div>
                        <div><img src = "Covid Care\Gloves\4_9_2.webp"></div>
                        <div><img src = "Covid Care\Gloves\dcg0004.jpg"></div>
                        <div><img src = "Covid Care\Gloves\sterile_gloves_4.webp"></div>
                        <div><img src = "https://5.imimg.com/data5/LO/CB/MY-9897738/surgical-gloves-500x500.jpg"></div>
                    </div>
                </div>
                <div class = "product-div-right">
                    <span class = "product-name">Hand Gloves</span>
                    ...
                    <p class = "product-description">Extra strength provides additional protection. The micro rough surface at the palm is designed for better.</p>
                    <br>
                    <p class = "product-description">
                        <ul class="product-description">
                        <h4>Benefits of Hand Gloves</h4>
                        
                        <li> Has better strength and provides effective protection.</li>
                        <li>Has a micro rough surface in the palm area that ensures a comfortable wet and dry grip.</li>  
                        <li>Bioburden & sterility tested and 100% inspected surgical latex gloves.</li>
                    ...
                    <br>
                    <h4>Side effects of Hand Gloves</h4>
                    <p class="product-description">
