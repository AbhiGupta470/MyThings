            ...
            <div class = "product-div">
                <div class = "product-div-left">
                    <div class = "img-container">
                        <img src = "https://m.media-amazon.com/images/I/71CcOCW2y8L._SY450_.jpg" alt = "watch">
                    </div>
                    <div class = "hover-container">
                        <div><img src = "https://m.media-amazon.com/images/I/71CcOCW2y8L._SY450_.jpg"></div>
                        <div><img src = "https://www.harishfoodzone.com/jb-content/uploads/2020/09/Sebamed-Baby-Lotion-100ml.jpg"></div>
                        <div><img src = "https://www.bigbasket.com/media/uploads/p/xxl/40028603-5_1-sebamed-baby-lotion.jpg"></div>
                        <div><img src = "https://cdn.firstcry.com/brainbees/images/Feature/710x859/48178-feature3.png"></div>
                        <div><img src = "https://onemg.gumlet.io/l_watermark_346,w_480,h_480/a_ignore,w_480,h_480,c_fit,q_auto,f_auto/js2ufv6n6u2vt1yaizmh.jpg"></div>
                        
                    </div>
                </div>
                <div class = "product-div-right">
                    <span class = "product-name">Sebamed Baby Lotion </span>
                    <span class = "product-price">₹ 1040.50</span>
                    ...
                    <p class = "product-description">Sebamed baby lotion is a specialised lotion designed for infants to care for their soft and sensitive skin. It is a premium quality baby lotion that is made in Germany using scientific laboratory testing to make it 100% safe for use on infants.
                        </p>
                    <br>
                    <p class = "product-description">
                        <ul class="product-description">
                        <h4>Uses of Sebamed Baby Lotion</h4>
                        
                        <li>The Sebamed baby lotion is used for satisfying all the skincare needs of infants older than 7 days. </li>
                        <li>It can also be used during winters to help keep the tender and sensitive skin of infants hydrated at all times.
                        </li>  
                        <!-- <li>It also helps in rejuvenating irritated skin. -->
                        <!-- </li>  -->
                    ...
                    <br>
                    <h4>Safety Information of Sebamed Baby Lotion</h4>
                    <p class="product-description">
                        <span>This lotion is for external use only and it cannot be applied to areas inside the mouth, nose, or ears or even on broken skin.</span>
                        <span>Always ensure that you read the label carefully to see whether the product is within its expiry date before applying it to your baby.</span>
                        <span>Keep out of reach of children and store in a cool and dry place.</span> 
